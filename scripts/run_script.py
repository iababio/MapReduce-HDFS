...
if len(args) != 2 or len(args[1].split("-")) != 2:
    print("Incorrect usage. Please provide the range in the format 'start_hour-end_hour', where start_hour < "
          "end_hour. Example: '0-1'")
    sys.exit(1)
...
# Run MapReduce
os.system("cat data/access.log | python mappers/mapper1.py | sort -k1,1 | python reducers/reducer1.py > "
          "data/intermediate_results.txt")
